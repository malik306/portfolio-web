...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"malik-portfolio.svg":[function(require,module,exports) {
module.exports = "/malik-portfolio.718be32c.svg";
},{}],"../functions/header-comps.js":[function(require,module,exports) {
"use strict";
...
var _malikPortfolio = _interopRequireDefault(require("../pages/malik-portfolio.svg"));

var _headerComps = require("../functions/header-comps");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function Header() {
  return "\n  <nav class=\"nav__bar\">\n    <a href=\"/\">\n      <img src=".concat(_malikPortfolio.default, " alt=\"Portfolio-Logo\"/>\n    </a>\n    <button class=\"nav__bar__burger\" onclick=").concat(_headerComps.Toggle, ">\n      <div></div>\n      <div></div>\n      <div></div>\n    </button>\n    <div class=\"nav__bar__list\">\n      <ul class=\"nav__bar__list__items\">\n        <li class=\"nav__bar__list__items__item\"><a class=\"nav__bar__list__items__item__link nav__bar__list__items__item--active\" href=\"/\">Home</a></li>\n        <li class=\"nav__bar__list__items__item\"><a class=\"nav__bar__list__items__item__link\" href=\"/portfolio-about\">About&nbsp;Me</a></li>\n        <li class=\"nav__bar__list__items__item\"><a class=\"nav__bar__list__items__item__link\" href=\"/portfolio-resume\">My&nbsp;Resume</a></li>\n        <li class=\"nav__bar__list__items__item\"><a class=\"nav__bar__list__items__item__link\" href=\"/portfolio-project\">My&nbsp;Projects</a></li>\n        <li class=\"nav__bar__list__items__item\"><a class=\"nav__bar__list__items__item__link\" href=\"/portfolio-github-api\">Github&nbsp;Api</a></li>\n      </ul>\n    </div>\n  </nav>\n  ");
}

var locHref = location.href;
var activeState = "nav__bar__list__items__item--active"; //console.log(document.querySelectorAll("a"));
},{"../pages/malik-portfolio.svg":"malik-portfolio.svg","../functions/header-comps":"../functions/header-comps.js"}],"../components/svg-code.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Phone = exports.Envelope = exports.MapMarker = exports.Facebook = exports.YouTube = exports.Twitter = exports.Github = exports.Instagram = void 0;
var Instagram = "<svg viewBox=\"0 0 448 512\"><path d=\"M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z\"/></svg>";
...
var Twitter = "<svg viewBox=\"0 0 512 512\"><path d=\"M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z\"/></svg>";
exports.Twitter = Twitter;
var YouTube = "<svg viewBox=\"0 0 576 512\"><path d=\"M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z\"/></svg>";
exports.YouTube = YouTube;
var Facebook = "<svg viewBox=\"0 0 320 512\"><path d=\"M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z\"/></svg>";
exports.Facebook = Facebook;
var MapMarker = "<svg viewBox=\"0 0 384 512\"><path d=\"M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z\"/></svg>";
exports.MapMarker = MapMarker;
var Envelope = "<svg viewBox=\"0 0 512 512\"><path d=\"M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z\"/></svg>";
exports.Envelope = Envelope;
var Phone = "<svg viewBox=\"0 0 512 512\"><path d=\"M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z\"/></svg>";
exports.Phone = Phone;
